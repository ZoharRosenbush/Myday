...
export class _BoardNav extends React.Component {
  ...
  render() {
    const { boards } = this.props;
    const { isBoardNavOpen } = this.state;
    const className = isBoardNavOpen
      ? "board-nav board-nav-open"
      : " board-nav board-nav-open closed";
          ...
          {isBoardNavOpen && (
            <React.Fragment>
              ...
              <div  className="main-workspace">
                <span className="main-m">M</span>
                <p className="main-p">Main Workspace</p>
              </div>
              <div className="side-bar-features-container">
                <button
                  className="side-bar-features"
